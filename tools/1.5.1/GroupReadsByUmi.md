...
|allow-inter-contig|x|Boolean|Allow read pairs with primary alignments on different contigs to be grouped when using the paired assigner (otherwise filtered out).|Optional|1|false|
